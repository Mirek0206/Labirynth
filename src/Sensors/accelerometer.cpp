...
void accelerometerInit( void )
{
    ...
    calmanFilterInit(&(accelerometerData.x_axis.calmanData), 0.001F, 0.03F, 0.0F);
    calmanFilterInit(&(accelerometerData.y_axis.calmanData), 0.001F, 0.03F, 0.0F);
    calmanFilterInit(&(accelerometerData.z_axis.calmanData), 0.001F, 0.03F, 0.0F);
};
